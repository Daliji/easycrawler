"""
Django settings for easycrawler project.
...
SECRET_KEY = '%%(*t3s@g+&1+)y_!)e6ar!mu$n1i@#4!11^ummm@9h$7v28k&'
...
MIDDLEWARE = [
    ...
    # 'django.middleware.csrf.CsrfViewMiddleware', # 需要CSRF校验
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'crawler/templates'),  # 添加内容
]
